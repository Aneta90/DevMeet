...
class GroupCrudFinder implements CrudEntityFinder<GroupDto, GroupEntity> {
    ...
    public GroupEntity findEntity(GroupDto dto) {
        ...
        if (group.isPresent())
            ...
            throw new IllegalArgumentException(GroupCrudStatusEnum.GROUP_NOT_FOUND.toString());
    }
    ...
    public List<GroupEntity> findEntities(GroupDto dto) {
        ...
        throw new IllegalArgumentException(GroupCrudStatusEnum.GROUPS_NOT_FOUND.toString());
    }
