...
public class MeetingCrudFacadeTest {
    ...
    @Test
    public void when_try_to_update_existing_meeting_with_meeting_number_of_other_entity_then_update_with_previous_meeting() throws MeetingNotFoundException, MeetingAlreadyExistsException { //nie może być dwóch meetingów o tym samym numerze
